<template>
    <div class="p-10">
        ...
        <div class="errors my-4">
            <div class="text-left text-red-700">test</div>
            <div class="text-left text-red-700">test</div>
        </div>
...
export default {
    ...
    methods: {
        async create(){
            // try{
            //     const res = await this.$axios.post('/real-estates/create', this.form)
            //     console.log('res', res)
            // }
            // catch(err){
            //     console.log(err)
            ...
            const res = await this.$axios.post('/real-estates/upload', fd, config)
            console.log('res', res)
        },
        async getAddress(){
            try {
        ...
        createImage(file){
            ...
            //     }
            // }
            // const res = await this.$axios.$post('/real-estates/upload', this.form, config)
